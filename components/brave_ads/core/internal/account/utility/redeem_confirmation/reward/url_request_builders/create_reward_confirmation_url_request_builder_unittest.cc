...
#include "unknown/components/brave_ads/core/internal/account/confirmations/user_data_builder/confirmation_user_data_builder_test_util.h"
...
TEST_F(BraveAdsCreateRewardConfirmationUrlRequestBuilderTest, BuildUrl) {
  ...
  expected_mojom_url_request->url = GURL(
      R"(https://anonymous.ads.bravesoftware.com/v3/confirmation/8b742869-6e4a-490c-ac31-)");
