...
#include "unknown/components/brave_ads/core/internal/catalog/catalog_url_request.h"
...
#include "unknown/components/brave_ads/core/internal/catalog/catalog_url_request_builder.h"
