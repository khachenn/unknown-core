...
#ifndef BRAVE_COMPONENTS_BRAVE_REWARDS_CORE_ENGINE_MIGRATIONS_PREF_MIGRATION_MANAGER_H_
...
#endif  // BRAVE_COMPONENTS_BRAVE_REWARDS_CORE_ENGINE_MIGRATIONS_PREF_MIGRATION_MANAGER_H_
