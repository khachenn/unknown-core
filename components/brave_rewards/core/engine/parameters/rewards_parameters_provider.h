...
#ifndef BRAVE_COMPONENTS_BRAVE_REWARDS_CORE_ENGINE_PARAMETERS_REWARDS_PARAMETERS_PROVIDER_H_
#define BRAVE_COMPONENTS_BRAVE_REWARDS_CORE_ENGINE_PARAMETERS_REWARDS_PARAMETERS_PROVIDER_H_
...
#endif  // BRAVE_COMPONENTS_BRAVE_REWARDS_CORE_ENGINE_PARAMETERS_REWARDS_PARAMETERS_PROVIDER_H_
