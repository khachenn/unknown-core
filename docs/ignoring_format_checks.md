...
| **JS/TS/CSS/etc.**   | `//unknown/.prettierignore`                 |
| **Python**           | `//unknown/.yapfignore`                     |
| **Rust**             | `//.rustfmt.toml` (via patching)          |
| **Swift**            | add `// swift-format-ignore-file` comment |
| **Presubmit Checks** | `//unknown/chromium_presubmit_config.json5` |
...
Prettier, add them to `//unknown/.prettierignore`.
...
The swift-format configuration is located at `//unknown/ios/.swift-format` and
