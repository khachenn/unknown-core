...
// label even when Browser::SupportsWindowFeature(Browser::FEATURE_TITLE_BAR)
// returns false at the time of creation, as users can switch tab orientation or
// title bar visibility by changing preferences.
