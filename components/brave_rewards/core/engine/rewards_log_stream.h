...
#ifndef BRAVE_COMPONENTS_BRAVE_REWARDS_CORE_ENGINE_REWARDS_LOG_STREAM_H_
#define BRAVE_COMPONENTS_BRAVE_REWARDS_CORE_ENGINE_REWARDS_LOG_STREAM_H_
...
#endif  // BRAVE_COMPONENTS_BRAVE_REWARDS_CORE_ENGINE_REWARDS_LOG_STREAM_H_
