...
import * as BraveNews from 'gen/unknown/components/brave_news/common/brave_news.mojom.m.js'
// Provide access to all the generated types
export * from 'gen/unknown/components/brave_news/common/brave_news.mojom.m.js'
