...
#ifndef BRAVE_COMPONENTS_BRAVE_REWARDS_CORE_ENGINE_WALLET_PROVIDER_TRANSFER_H_
#define BRAVE_COMPONENTS_BRAVE_REWARDS_CORE_ENGINE_WALLET_PROVIDER_TRANSFER_H_
...
#endif  // BRAVE_COMPONENTS_BRAVE_REWARDS_CORE_ENGINE_WALLET_PROVIDER_TRANSFER_H_
