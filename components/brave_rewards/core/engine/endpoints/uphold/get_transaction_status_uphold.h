...
#ifndef BRAVE_COMPONENTS_BRAVE_REWARDS_CORE_ENGINE_ENDPOINTS_UPHOLD_GET_TRANSACTION_STATUS_UPHOLD_H_
#define BRAVE_COMPONENTS_BRAVE_REWARDS_CORE_ENGINE_ENDPOINTS_UPHOLD_GET_TRANSACTION_STATUS_UPHOLD_H_

#include <optional>
#include <string>
#include <vector>

#include "unknown/components/brave_rewards/core/engine/endpoints/common/get_transaction_status.h"
...
#endif  // BRAVE_COMPONENTS_BRAVE_REWARDS_CORE_ENGINE_ENDPOINTS_UPHOLD_GET_TRANSACTION_STATUS_UPHOLD_H_
