...
#ifndef BRAVE_COMPONENTS_BRAVE_REWARDS_CORE_ENGINE_TEST_REWARDS_ENGINE_TEST_H_
#define BRAVE_COMPONENTS_BRAVE_REWARDS_CORE_ENGINE_TEST_REWARDS_ENGINE_TEST_H_
...
#endif  // BRAVE_COMPONENTS_BRAVE_REWARDS_CORE_ENGINE_TEST_REWARDS_ENGINE_TEST_H_
