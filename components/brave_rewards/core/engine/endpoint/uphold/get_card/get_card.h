...
#ifndef BRAVE_COMPONENTS_BRAVE_REWARDS_CORE_ENGINE_ENDPOINT_UPHOLD_GET_CARD_GET_CARD_H_
#define BRAVE_COMPONENTS_BRAVE_REWARDS_CORE_ENGINE_ENDPOINT_UPHOLD_GET_CARD_GET_CARD_H_
...
#endif  // BRAVE_COMPONENTS_BRAVE_REWARDS_CORE_ENGINE_ENDPOINT_UPHOLD_GET_CARD_GET_CARD_H_
