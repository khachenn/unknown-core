...
#ifndef BRAVE_COMPONENTS_BRAVE_REWARDS_CORE_ENGINE_ENDPOINT_UPHOLD_POST_CARDS_POST_CARDS_H_
#define BRAVE_COMPONENTS_BRAVE_REWARDS_CORE_ENGINE_ENDPOINT_UPHOLD_POST_CARDS_POST_CARDS_H_
...
#endif  // BRAVE_COMPONENTS_BRAVE_REWARDS_CORE_ENGINE_ENDPOINT_UPHOLD_POST_CARDS_POST_CARDS_H_
