...
import { RANDOM_SOLID_COLOR_VALUE, RANDOM_GRADIENT_COLOR_VALUE, MAX_CUSTOM_IMAGE_BACKGROUNDS } from 'gen/unknown/components/brave_new_tab_ui/brave_new_tab_page.mojom.m.js'
