...
#ifndef BRAVE_COMPONENTS_BRAVE_REWARDS_CORE_ENGINE_WALLET_PROVIDER_SOLANA_SOLANA_WALLET_PROVIDER_H_
#define BRAVE_COMPONENTS_BRAVE_REWARDS_CORE_ENGINE_WALLET_PROVIDER_SOLANA_SOLANA_WALLET_PROVIDER_H_
...
#endif  // BRAVE_COMPONENTS_BRAVE_REWARDS_CORE_ENGINE_WALLET_PROVIDER_SOLANA_SOLANA_WALLET_PROVIDER_H_
