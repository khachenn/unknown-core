...
#ifndef BRAVE_COMPONENTS_BRAVE_REWARDS_CORE_ENGINE_CONTRIBUTION_CONTRIBUTION_MONTHLY_H_
#define BRAVE_COMPONENTS_BRAVE_REWARDS_CORE_ENGINE_CONTRIBUTION_CONTRIBUTION_MONTHLY_H_
...
#endif  // BRAVE_COMPONENTS_BRAVE_REWARDS_CORE_ENGINE_CONTRIBUTION_CONTRIBUTION_MONTHLY_H_
