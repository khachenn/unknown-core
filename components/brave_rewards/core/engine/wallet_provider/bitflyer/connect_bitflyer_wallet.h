...
#ifndef BRAVE_COMPONENTS_BRAVE_REWARDS_CORE_ENGINE_WALLET_PROVIDER_BITFLYER_CONNECT_BITFLYER_WALLET_H_
#define BRAVE_COMPONENTS_BRAVE_REWARDS_CORE_ENGINE_WALLET_PROVIDER_BITFLYER_CONNECT_BITFLYER_WALLET_H_
...
#endif  // BRAVE_COMPONENTS_BRAVE_REWARDS_CORE_ENGINE_WALLET_PROVIDER_BITFLYER_CONNECT_BITFLYER_WALLET_H_
