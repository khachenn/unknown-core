...
#ifndef BRAVE_COMPONENTS_BRAVE_REWARDS_CORE_ENGINE_ENDPOINT_UPHOLD_GET_CARDS_GET_CARDS_H_
#define BRAVE_COMPONENTS_BRAVE_REWARDS_CORE_ENGINE_ENDPOINT_UPHOLD_GET_CARDS_GET_CARDS_H_
...
#endif  // BRAVE_COMPONENTS_BRAVE_REWARDS_CORE_ENGINE_ENDPOINT_UPHOLD_GET_CARDS_GET_CARDS_H_
