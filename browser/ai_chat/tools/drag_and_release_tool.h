...
#ifndef BRAVE_BROWSER_AI_CHAT_TOOLS_DRAG_AND_RELEASE_TOOL_H_
#define BRAVE_BROWSER_AI_CHAT_TOOLS_DRAG_AND_RELEASE_TOOL_H_
...
#endif  // BRAVE_BROWSER_AI_CHAT_TOOLS_DRAG_AND_RELEASE_TOOL_H_
