...
#define BRAVE_COMPONENTS_BRAVE_REWARDS_CONTENT_REWARDS_SERVICE_H_
...
class RewardsService : public KeyedService {
 public:
  ...
  virtual void SetPublisherExclude(const std::string& publisher_key,
                                   bool exclude) = 0;
  ...
  virtual void GetShareURL(const base::flat_map<std::string, std::string>& args,
  ...
  virtual void GetAllContributions(GetAllContributionsCallback callback) = 0;
  ...
  virtual void LoadDiagnosticLog(const int num_lines,
...
#endif  // BRAVE_COMPONENTS_BRAVE_REWARDS_CONTENT_REWARDS_SERVICE_H_
