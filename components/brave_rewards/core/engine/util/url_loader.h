...
#ifndef BRAVE_COMPONENTS_BRAVE_REWARDS_CORE_ENGINE_UTIL_URL_LOADER_H_
#define BRAVE_COMPONENTS_BRAVE_REWARDS_CORE_ENGINE_UTIL_URL_LOADER_H_
...
#endif  // BRAVE_COMPONENTS_BRAVE_REWARDS_CORE_ENGINE_UTIL_URL_LOADER_H_
