...
#ifndef BRAVE_COMPONENTS_BRAVE_REWARDS_CORE_ENGINE_ENDPOINTS_GEMINI_GET_RECIPIENT_ID_GEMINI_H_
#define BRAVE_COMPONENTS_BRAVE_REWARDS_CORE_ENGINE_ENDPOINTS_GEMINI_GET_RECIPIENT_ID_GEMINI_H_
...
#endif  // BRAVE_COMPONENTS_BRAVE_REWARDS_CORE_ENGINE_ENDPOINTS_GEMINI_GET_RECIPIENT_ID_GEMINI_H_
