...
#ifndef BRAVE_COMPONENTS_BRAVE_REWARDS_CORE_ENGINE_ENDPOINT_UPHOLD_PATCH_CARD_PATCH_CARD_H_
#define BRAVE_COMPONENTS_BRAVE_REWARDS_CORE_ENGINE_ENDPOINT_UPHOLD_PATCH_CARD_PATCH_CARD_H_
...
#endif  // BRAVE_COMPONENTS_BRAVE_REWARDS_CORE_ENGINE_ENDPOINT_UPHOLD_PATCH_CARD_PATCH_CARD_H_
