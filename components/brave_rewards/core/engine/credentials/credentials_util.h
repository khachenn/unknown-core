...
#ifndef BRAVE_COMPONENTS_BRAVE_REWARDS_CORE_ENGINE_CREDENTIALS_CREDENTIALS_UTIL_H_
#define BRAVE_COMPONENTS_BRAVE_REWARDS_CORE_ENGINE_CREDENTIALS_CREDENTIALS_UTIL_H_
...
#endif  // BRAVE_COMPONENTS_BRAVE_REWARDS_CORE_ENGINE_CREDENTIALS_CREDENTIALS_UTIL_H_
