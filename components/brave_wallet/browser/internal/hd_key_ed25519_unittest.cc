...
TEST(HDKeyEd25519UnitTest, TestVector1) {
  ...
  EXPECT_EQ(base::HexEncodeLower(master_key->GetPrivateKeyBytes()),
            "2b4be7f19ee27bbf30c667b642d5f4aa69fd169872f8fc3059c08ebae2eb19e7");
  EXPECT_EQ(base::HexEncodeLower(master_key->GetPublicKeyBytes()),
  ...
  EXPECT_EQ(base::HexEncodeLower(child->GetPrivateKeyBytes()),
            "8f94d394a8e8fd6b1bc2f3f49f5c47e385281d5c17e65324b0f62483e37e8793");
  EXPECT_EQ(base::HexEncodeLower(child->GetPublicKeyBytes()),
