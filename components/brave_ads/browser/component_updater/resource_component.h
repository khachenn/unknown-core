...
#include "unknown/components/brave_ads/browser/component_updater/resource_component_observer.h"
...
#include "unknown/components/brave_ads/browser/component_updater/resource_info.h"
